...
For some exercises and assignment you need an RStudio Server account. You will get an account before the start of the course.
...
## Exam
The credits for this course can be earned by handing in the final exam assignment. The details are described in chapter \@ref(portfolioexam). In short: You will have to publish a bookdown project to the Course publication server (RStudio Connect). This page will function as a portfolio where you will post all the assignments and output products of the course. Only the lecturers of the course will have access to your portfolio products.  
